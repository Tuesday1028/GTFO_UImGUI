...
namespace Hikaria.UImGUI.Platform
{
	...
	internal sealed class InputManagerPlatform : PlatformBase
	{
		...
		public override bool Initialize(ImGuiIOPtr io, ImGuiPlatformIOPtr platformio, UIOConfig config, string platformName)
		{
			base.Initialize(io, platformio, config, platformName);
