...
namespace Hikaria.UImGUI
{
	...
	{
		[Description("TTF/OTF data ownership taken by the container ImFontAtlas (will delete memory itself). (default=true)")]
		public bool FontDataOwnedByAtlas;

		[Description("Index of font within TTF/OTF file. (default=0)")]
		public int FontNo;

		[Description("Size in pixels for rasterizer (more or less maps to the resulting font height).")]
		public float SizeInPixels;

		[Description("Rasterize at higher quality for sub-pixel positioning. " +
		...
		[Description("Align every glyph to pixel boundary." +
		...
		[Description("Extra spacing (in pixels) between glyphs. Only X axis is supported for now. (default=0, 0)")]
		public Vector2 GlyphExtraSpacing;

		[Description("Offest all glyphs from this font input. (default=0, 0)")]
		public Vector2 GlyphOffset;

		[Description("Glyph ranges for different writing systems.")]
		public ScriptGlyphRanges GlyphRanges;

		[Description("Minimum AdvanceX for glyphs, set Min to align font icons, set both Min/Max to enforce mono-space font. (default=0, 0)")]
		public float GlyphMinAdvanceX;

		[Description("Maximum AdvanceX for glyphs. (default=float_max)")]
		public float GlyphMaxAdvanceX;

		[Description("Merge into previous ImFont, so you can combine multiple " +
		...
		[Description("Settings for custom font builder. THIS IS BUILDER IMPLEMENTATION DEPENDENT. Leave as zero if unsure. (default=0)")]
		public uint FontBuilderFlags;

		[Description("Brighten (>1.0f) or darken (<1.0f) font output. " +
			"Brightening small fonts may be a good workaround to make them more readable. (default=1.0f)")]
		public float RasterizerMultiply;

		[Description("Explicitly specify unicode codepoint of ellipsis character. " +
