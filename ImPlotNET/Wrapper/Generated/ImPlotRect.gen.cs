...
namespace ImPlotNET
{
    ...
    public unsafe partial struct ImPlotRectPtr
    {
        ...
        public ImPlotPoint Clamp(ImPlotPoint p)
        {
            ...
            ImPlotNative.ImPlotRect_Clamp_PlotPoInt(&__retval, NativePtr, p);
            return __retval;
        }
        public ImPlotPoint Clamp(double x, double y)
        {
            ImPlotPoint __retval;
            ImPlotNative.ImPlotRect_Clamp_double(&__retval, NativePtr, x, y);
            return __retval;
        }
        ...
        {
            ImPlotPoint __retval;
            ImPlotNative.ImPlotRect_Max(&__retval, NativePtr);
            return __retval;
        }
        public ImPlotPoint Min()
        {
            ImPlotPoint __retval;
            ImPlotNative.ImPlotRect_Min(&__retval, NativePtr);
            return __retval;
        }
        public ImPlotPoint Size()
        {
            ImPlotPoint __retval;
            ImPlotNative.ImPlotRect_Size(&__retval, NativePtr);
            return __retval;
        }
    }
}
